...
import { Edit3, Trash2, MoreHorizontal, Package, TrendingUp, Eye } from 'lucide-react';
...
const ProductList: React.FC<ProductListProps> = ({ products, onAdd, onEdit, onDelete}) => {
  ...
  // Explicit render function for more menu to avoid ESLint warning
  const renderMoreMenu = (product: Product) => {
    if (openMoreMenu !== product.productId) return null;
    return (
          ...
          >
            ...
            <div className="relative aspect-[4/3] overflow-hidden bg-gray-100">
              <Image
                ...
                unoptimized={true} // opt out of optimization if external image (optional)
              />
